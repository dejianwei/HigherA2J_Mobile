...
public class TofCamera extends CameraDevice.StateCallback{
    ...
    public TofCamera(Context context, TofCameraLiveActivity depthFrameVisualizer) {
        ...
        previewReader = ImageReader.newInstance(TofCameraListener.WIDTH,
                TofCameraListener.HEIGHT, ImageFormat.DEPTH16,2);
        ...
        try {
            for (String camera : cameraManager.getCameraIdList()) {
                ...
                if (depthCapable && facingFront) {
                    ...
                    Log.i(TAG, "intrinsic calibration: " + Arrays.toString(intrinsic_param));
